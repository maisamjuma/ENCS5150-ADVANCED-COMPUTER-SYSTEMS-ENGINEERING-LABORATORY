...
public class HawaiianFragment extends Fragment {
    ...
    public HawaiianFragment() {
        // Required empty public constructor
    }

    // Factory method to create a new instance of this fragment
    public static HawaiianFragment newInstance(int pizzaImageResource, String pizzaName) {
        HawaiianFragment fragment = new HawaiianFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_hawaiian_fragment, container, false);
        ...
        RelativeLayout rootLayout = rootView.findViewById(R.id.hawaiianRootLayout);
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("hawaiian");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("hawaiian");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("hawaiian", isFavorite); // Pass pizza type

...
public class MushroomFragment extends Fragment {
    ...
    public static MushroomFragment newInstance(int pizzaImageResource, String pizzaName) {
        MushroomFragment fragment = new MushroomFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_mushroom_fragment, container, false);
        ...
        RelativeLayout rootLayout = rootView.findViewById(R.id.mushroomRootLayout);
        ...
        RadioButton Rlarge = rootView.findViewById(R.id.radioMedium);
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("mushroom");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("mushroom");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("mushroom", isFavorite); // Pass pizza type

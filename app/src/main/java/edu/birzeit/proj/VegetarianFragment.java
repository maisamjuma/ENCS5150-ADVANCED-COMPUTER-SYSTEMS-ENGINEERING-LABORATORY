...
public class VegetarianFragment extends Fragment {
    ...
    public static VegetarianFragment newInstance(int pizzaImageResource, String pizzaName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("vegetarian");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("vegetarian");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("vegetarian", isFavorite); // Pass pizza type

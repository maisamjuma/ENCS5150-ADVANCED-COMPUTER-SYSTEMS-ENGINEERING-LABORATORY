...
public class TandooriFragment extends Fragment {
    ...
    public TandooriFragment() {
        // Required empty public constructor
    }

    // Factory method to create a new instance of this fragment
    public static TandooriFragment newInstance(int pizzaImageResource, String pizzaName) {
        TandooriFragment fragment = new TandooriFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_tandoori_fragment, container, false);
        ...
        RelativeLayout rootLayout = rootView.findViewById(R.id.tandooriRootLayout);
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("tandoori");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("tandoori");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("tandoori", isFavorite); // Pass pizza type

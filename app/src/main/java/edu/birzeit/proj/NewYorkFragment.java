...
public class NewYorkFragment extends Fragment {
    ...
    public static NewYorkFragment newInstance(int pizzaImageResource, String pizzaName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_new_york_fragment, container, false);
        ...
        RelativeLayout rootLayout = rootView.findViewById(R.id.newyorkRootLayout);
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("new york");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("new york");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("new york", isFavorite); // Pass pizza type

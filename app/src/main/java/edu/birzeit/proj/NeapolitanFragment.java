...
public class NeapolitanFragment extends Fragment {
    ...
    public NeapolitanFragment() {
        // Required empty public constructor
    }

    // Factory method to create a new instance of this fragment
    public static NeapolitanFragment newInstance(int pizzaImageResource, String pizzaName) {
        NeapolitanFragment fragment = new NeapolitanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_neapolitan_fragment, container, false);
        ...
        RelativeLayout rootLayout = rootView.findViewById(R.id.neaRootLayout);
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("neapolitan");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("neapolitan");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("neapolitan", isFavorite); // Pass pizza type

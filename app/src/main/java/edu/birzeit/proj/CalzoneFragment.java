...
public class CalzoneFragment extends Fragment {
    ...
    public CalzoneFragment() {
        // Required empty public constructor
    }

    // Factory method to create a new instance of this fragment
    public static CalzoneFragment newInstance(int pizzaImageResource, String pizzaName) {
        CalzoneFragment fragment = new CalzoneFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_calzone_fragment, container, false);
        ...
        RelativeLayout rootLayout = rootView.findViewById(R.id.calzoneRootLayout);
        ...
        boolean isFavorite = restoreFavoriteStatusFromSharedPreferences("calzone");
        if (isFavorite) {
        ...
        heartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isFavorite = toggleFavoriteStatus("calzone");
                // Update SharedPreferences with the new favorite status
                saveFavoriteStatusToSharedPreferences("calzone", isFavorite); // Pass pizza type
